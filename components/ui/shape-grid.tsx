...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  useEffect(() => {
    ...
    // ─── Window-level mouse tracking (works behind content) ───
    const handleMouseMove = (event: MouseEvent) => {
      const cell = getHoveredCell(event.clientX, event.clientY);
      if (
    ...
    // Use window-level events so hover works even when content sits above canvas
